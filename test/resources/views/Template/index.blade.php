                                            ...
                                            <div class="modal-body">
                                                <form method="post"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="nama_template" class="form-control" id="nama_template" value="{{ $template->nama_template }}"required>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="link_template" class="form-control" id="link_template" value="{{ $template->link_template }}" required>
                                                    </div>                                                        
